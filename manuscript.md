...
The effects of stressors on species within a food web can be observed by examining both direct and indirect interactions between species. The maintenance of food web complexity and biodiversity relies on the fundamental role played by indirect effects. Overlooking indirect interactions can lead to incorrect assessments of how perturbations impact natural communities. The dynamic stability of the system and how disturbances propagate depends on the strength and position of interactions within the food web. Predicting the impacts of perturbations on species within a food web is challenging due to the general lack of understanding regarding the strength of species interactions. With knowledge of interaction strengths, the method of the inverse Jacobian matrix can be used to measure the effects of changes in species populations on the remaining species in a food web. Results depend on the particular food web, but when applying this method to several empirical food webs, perturbations to species with limited connections were found to have larger net effects on the rest of the food web compared to disturbances affecting highly connected species [@Montoya2009].

The magnitudes of net effects are negatively correlated with the linkage density of the perturbed species in most analyzed food webs. Species with few connections have considerably stronger net effects on other species within food webs relative to highly connected species. Highly connected species may possess compensatory mechanisms, such as enhanced apparent competition, that can regulate their biomass and mitigate the impacts of disturbances [@Montoya2009]. 

Similarly @Zhao2016 showed that the extinction of species that are considered "hubs" in food webs, meaning they feed on or are fed on by many others, may not necessarily cause the greatest threat of further biodiversity loss. Instead, the strength of feeding links (link weight) and the prevalence of indirect interactions have a stronger effect on food-web stability. Both quantitative fluxes and species dissipating their effects across many links should be of great concern in biodiversity conservation. The potential for "hubs" to act as keystone species may have been exaggerated in previous studies.

The propagation of stressor-induced perturbations across food webs is significantly influenced by species interactions and cascading effects. Due to differences in timescales and interacting species, stressor impacts can vary in direction and magnitude as they move through the food web. Nevertheless, understanding the temporal dimension of indirect effects and the role of multiple stressors in food webs is still limited [@Jackson2021].

"Degree gives a very robust prediction on species importance, more or less correlating with ranks provided by other indices. Many definitions have been suggested for keystone species (Power et al. 1996) and we do not think that network position, in itself, is particularly better. It is, of course, very important to consider abundance or biomass." [@Jordan2006]
...
Decreased krill abundances have the potential to result in reduced carbon flux due to the significant contribution of krill fecal pellets to exported carbon [@Pauli2021]. Furthermore, in a warmer and more stable water column with a shallow upper mixed layer, the dominance of cryptophytes over diatoms may favor salp populations over krill populations, thereby reducing the magnitude of energy transfer to upper trophic levels and the seabed [@Isla2023]. These findings further highlight the influence of phytoplankton dynamics on carbon flux and suggest a consequential impact on benthic ecosystems [@Constable2014].
...
A southward movement of Southern Ocean frontal systems is expected to cause southward shifts in the distributions of myctophid fish species (Gymnoscopelus braueri) , given their strong association with fronts, probably increasing their density in the Weddel Sea shelf [@Constable2014] 
...
Notothenioid fishes in the Weddell Sea region (Pleuragramma antarcticum) face multiple stressors that threaten their survival and ecological interactions. Rising water temperatures, particularly when combined with ocean acidification, pose a major threat to their persistence. While some species exhibit physiological plasticity to compensate for increased oxygen demand, most notothenioid fishes are stenothermal and unable to adjust their metabolic functioning. Channichthyids (Chionodraco myersi, C. antarcticus and Pagetopsis maculatus), in particular, are highly vulnerable to changes in the abiotic environment as they lack the capacity to adapt blood parameters to meet increasing oxygen demand. The early developmental stages of fish species are also highly vulnerable to various abiotic alterations, including changes in salinity. Furthermore, the vulnerability of fish species to changes in food web structure and dynamics, such as shifts in prey availability, varies among trophic groups. Plankton consumers, which specialize in a narrow size prey spectrum, are particularly sensitive to changes in prey availability (P. antarcticum, C. myersi, C. antarcticus and P. maculatus ), while fish species that include a proportion of benthic organisms in their diet exhibit lower trophic vulnerability. The loss of sea ice extent and duration due to climate-driven warming poses a significant threat to species strongly associated with sea ice, affecting their life stages and habitat availability [@Mintenbeck2012]. 

<!-- Seals -->

The impacts of climate change in Antarctica and the Southern Ocean are not uniform, and different species with varying life-history characteristics are expected to respond differently to the changing ecosystems. Studies have indicated that Weddell seals (Leptonychotes weddellii) and crabeater seals (Lobodon carcinophagus) exhibit varying levels of sensitivity to climate change. Crabeater seals, which exhibit a preference for breeding in close proximity to krill, are particularly susceptible to changes in sea ice concentrations, sea surface temperatures, and the availability of stable breeding ice. These factors can significantly affect their post-breeding foraging success and, ultimately, their future breeding success. On the other hand, Weddell seals in the Ross Sea region show a preference for breeding near larger colonies of emperor penguins. This suggests that the Weddell Sea may currently offer a prey-abundant environment, facilitating the coexistence of the only two air-breathing predators of Antarctic silverfish (Pleuragramma antarcticum), Weddell seals, and emperor penguins, in closer proximity to each other [@Wege2021; @Siniff2008]. 

Leopard (Hydrurga leptonyx) and Ross seals (Ommataphoca rossii) are less influenced by sea ice changes, but their food resources may still be affected. Antarctic fur seals (Arctocephalus gazella) face potential food shortages as krill abundance decreases. Elephant seals (Mirounga leonina) are expanding southward and dealing with altered food webs due to disintegrating ice shelves and receding sea ice [@Siniff2008].

<!-- Birds --> 

In the case of birds, Thalassoica antarctica (Antarctic petrel), the numerically dominant species making up over 40% of individuals recorded. As a sea ice dependent forager and breeder, loss of this habitat will degrade its foraging success and reproductive output over time. Pagodroma nivea (snow petrel) also relies heavily on sea ice for foraging and its colonies near the study area may be affected. Aptenodytes forsteri (emperor penguin) uses sea ice for breeding and any reductions could constrain its populations. Sterna paradisaea (Arctic tern) spends summer in the Antarctic exploiting krill swarms under receding ice edges, so declines in ice cover may reduce prey availability and quality of molting habitats. Continued warming is thus expected to gradually erode the abundance and distribution of these 'primary species' that dominate the avifauna of the Weddell Sea through loss of critical sea ice habitat [@Orgeira2021].

Humpback whales (Megaptera novaeangliae) are important predators on the region [@Wege2021]. Variations in Antarctic sea ice extent driven by climate change have implications for humpback whale populations through impacts on their primary prey resource of krill [@Braithwaite2015]. Decreased winter ice coverage results in reduced suitable habitat and lower krill abundance [@Braithwaite2015], with flow-on effects for whale body condition observed historically in harvest data. More recently in the rapidly warming Western Antarctic Peninsula, declining seasonal ice extent has corresponded to decreases in both krill stocks and humpback whale pregnancy rates that positively correlated with prior prey availability and ice conditions [@Pallin2023]. With climate projections indicating ongoing sea ice losses, further threats to critical krill populations pose risks to the energy intake and reproductive success and long-term viability of humpback whale populations dependent on consistent Antarctic feeding [@Pallin2023].
